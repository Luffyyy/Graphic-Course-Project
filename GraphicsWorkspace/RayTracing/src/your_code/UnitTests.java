...
public class UnitTests {
	...
	private static void testLightingEquation_ChangeInputs() {
		Vector3f[] vectors = {
		    new Vector3f(1),
		    new Vector3f(2),
		    new Vector3f(3),
		...
		WorldModel.lightingEquation(vectors[0], vectors[1], vectors[2], vectors[3], vectors[4], vectors[5], 0.42f);
		for (int i = 0; i < vectors.length; i++) {
		    if (!vectors[i].equals(new Vector3f(i+1))) {
		        System.out.println("At least one of lightingEquation input vector has changed");
		        return;
		    }
		}
		System.out.println("lightingEquation test passed");
	}
	...
	private static void testCalcKdCombinedWithTexture_ChangeInputs() throws IOException {
		Vector3f[] vectors = {
			    new Vector3f(1),
			    new Vector3f(2),
			    new Vector3f(3)
		...
		WorldModel.calcKdCombinedWithTexture(vectors[0], vectors[1], intersectedSphereTexture, vectors[2], 0.23f);
		for (int i = 0; i < vectors.length; i++) {
		    if (!vectors[i].equals(new Vector3f(i+1))) {
		        System.out.println("At least one of calcKdCombinedWithTexture input vector has changed");
		        return;
		    }
		}
		System.out.println("calcKdCombinedWithTexture test passed");
	}
	...
	public static void main(String[] args) throws IOException {
	    System.out.println("\nTest if LightingEquation change its inputs");
	    System.out.println("=========================");
	    testLightingEquation_ChangeInputs();
	    ...
	    System.out.println("\nTest if calcKdCombinedWithTexture change its inputs");
	    System.out.println("=========================");
	    testCalcKdCombinedWithTexture_ChangeInputs();    
