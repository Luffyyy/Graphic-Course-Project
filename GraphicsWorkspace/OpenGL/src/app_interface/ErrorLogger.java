...
public class ErrorLogger {
    ...
    public static void main(String[] args) {
        ...
        // Display error report in a Swing window
        logger.showErrorWindowSwing();

        // For JavaFX usage, ensure you're in an Application context
        // javafx.application.Application.launch(SomeApp.class);
        // Then inside the FX app: ErrorLogger.getInstance().showErrorWindowFx();
    }
}
