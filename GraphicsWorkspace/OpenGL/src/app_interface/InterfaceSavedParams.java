...
//	private boolean displayWireframe;	
...
//	private ExerciseEnum exercise;
	...
	public void setDefaultParams() {
		...
		shadersFolder = InterfaceDefaultParams.shadersFolder;
//		displayWireframe = InterfaceDefaultParams.displayWireframe;
...
//		exercise = InterfaceDefaultParams.exNum;
	...
	public void setShadersFolder(String shadersFolder) {
...
//	public boolean isDisplayWireframe() {
//		return displayWireframe;
//	}
//
//	public void setDisplayWireframe(boolean displayWireframe) {
//		this.displayWireframe = displayWireframe;
//		try {
//			saveToFile();
//		} catch (Exception e) {
//			System.out.println("could not save parameters to file.");
...
//	}
	...
	public void saveToFile() throws Exception {
		...
		addElementToFile(rootElement, doc, "shadersFolder", shadersFolder);
//		addElementToFile(rootElement, doc, "displayWireframe", displayWireframe);
...
//		addElementToFile(rootElement, doc, "exercise", exercise);
	...
	private void loadFromFile() throws Exception {
		...
		shadersFolder = parseParamString(rootElement, "shadersFolder");
//		displayWireframe = parseParamBoolean(rootElement, "displayWireframe");
...
//		return "AppParams [modelFileName=" + modelFileName + ", shadersFolder=" + shadersFolder + ", displayWireframe=" + displayWireframe + "]";
		return "AppParams [modelFileName=" + modelFileName + ", shadersFolder=" + shadersFolder + "]";
	}
	...
	public static void main(String[] args) {
    	...
    	p1.setShadersFolder("./models/firstShaders/");
//    	p1.setDisplayWireframe(true);
