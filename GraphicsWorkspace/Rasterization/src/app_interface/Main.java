...
public class Main extends Application {
	...
	WorldModel worldModel = new WorldModel(IMAGE_WIDTH,IMAGE_HEIGHT, errorLogger);
...
//        	comboYourSelection.getItems().add(sel);
        ...
        VBox vbox = new VBox(dropdownRow, imageView, labelInfo1, labelInfo2, labelInfo3, labelInfo4, hboxExercise, hboxOpenLog);
